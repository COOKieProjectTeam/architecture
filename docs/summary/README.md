...
При переходе **`vault_only` → `dual_so_t`** и переносе документации в репозиторий тот же URL имеет смысл **продублировать** в [[Knowledge/Development/Projects/COOKie/SYNC|SYNC.md]].
